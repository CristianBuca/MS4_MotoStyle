...
def checkout(request):
    """
    Defines the checkout view and handles POST requests from checkout form
        Arguments: request (object): The checkout request
...
# Attempt to prefill the form with info the user saved in their profile
...
def checkout_success(request, order_number):
    """
    Defines the successful checkout view to be displayed after payment
        Arguments:
            request (object): Request object
            order_number: The number of the order that was registered
        Returns: render checkout success page
    """
